 ...
 * abstract Db class.
 */
class ArDb extends \Components\ArComponent {
    ...
    public function read($name = 'default')
    {
        ...
        if (isset(self::$readConnections[$name]))
            ...
            throw new \Core\ArDbException('dbReadConfig not hava a param ' . $name, 1);
    ...
    public function write($name = 'default')
    {
        ...
        if (isset(self::$writeConnections[$name]))
            ...
            throw new \Core\ArDbException('dbWriteConfig not hava a param ' . $name, 1);
